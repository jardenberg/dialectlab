      ...
      warnings:
        audioBackend === 'elevenlabs_tts'
          ? [
              ...
              'This build defaults to ElevenLabs Flash v2.5 for lower latency. Switch ELEVENLABS_MODEL_ID back to eleven_multilingual_v2 if you prefer slightly higher fidelity over speed.',
            ]
          : speakerMode === 'builtin'
          ? [
