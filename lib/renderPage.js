const { APP_VERSION, ASSET_VERSION, BASE_URL, LOCALE_OPTIONS, getAlternateLinks, getCanonicalUrl, getLocalePath, shared } = require('./locales');
...
function renderPage(locale, bundle) {
  ...
  const localeLinks = LOCALE_OPTIONS.map(
    (option) =>
